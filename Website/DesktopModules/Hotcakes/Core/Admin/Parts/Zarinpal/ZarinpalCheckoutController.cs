	...
	public class ZarinpalCheckoutController : BaseStoreController
	{
		...
		public ActionResult Index()
		{
			...
			if (flag2)
			{
				...
				if (flag3)
				{
                    Hotcakes.Modules.com.zarinpal.ir.PaymentGatewayImplementationService paymentGatewayImplementationService = new Hotcakes.Modules.com.zarinpal.ir.PaymentGatewayImplementationService();
				...
				{
                    Hotcakes.Modules.com.zarinpal.de.PaymentGatewayImplementationService paymentGatewayImplementationService2 = new Hotcakes.Modules.com.zarinpal.de.PaymentGatewayImplementationService();
