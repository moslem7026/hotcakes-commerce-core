...
<div class="hcForm">
    <div class="hcFormItem">
        <label class="hcLabel">اطلاعات پرداخت</label>
        <table width="100%">
            <tr>
