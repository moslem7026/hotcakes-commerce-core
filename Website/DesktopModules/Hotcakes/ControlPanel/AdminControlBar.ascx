        ...
        <div id="ControlBar">
            <div class="ControlContainer">
                ...
                <ul id="ControlNavQuickLink">
                    <li>
                        <a id="GoToStore" href="<%=Hotcakes.Commerce.Urls.HccUrlBuilder.RouteHccUrl(Hotcakes.Commerce.Urls.HccRoute.Home) %>">
                            <img src="/DesktopModules/Hotcakes/ControlPanel/controlbarimages/Store-icon.png" />
                            <%=GetString("ViewShop.Text")  %></a>
                    </li>
                    <li>
