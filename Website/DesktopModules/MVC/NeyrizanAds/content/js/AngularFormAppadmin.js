...
routerApp.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('home', {
        ...
        .state('Rooms', {
            ...
            views: {
                '': {
                    templateUrl: '/DesktopModules/MVC/NeyrizanAds/content/Angular/RoomsLists.html',
            ...
            views: {
                '': {
                    templateUrl: '/DesktopModules/MVC/NeyrizanAds/content/Angular/Cards.html',
                    controller: 'ctrCards'
                }
            ...
            views: {
                '': {
                    templateUrl: '/DesktopModules/MVC/NeyrizanAds/content/Angular/PackageLists.html',
            ...
            views: {
                '': {
                    templateUrl: '/DesktopModules/MVC/NeyrizanAds/content/Angular/PackageDetails.html',
            ...
            views: {
                '': {
                    templateUrl: '/DesktopModules/MVC/NeyrizanAds/content/Angular/RoomsPackageDetails.html',
...
routerApp.controller('ctrCards', function ($scope, $http, $stateParams) {
    $.ajax({
        url: siteRoot + "DesktopModules/MVC/NeyrizanAds/Package/GetCards",
        method: "Get",
        headers: {
            "ModuleId": ModuleId,
            "TabId": TabId,
    ...
    $.ajax({
        url: "/DesktopModules/MVC/NeyrizanAds/Package/GetAllPackages",
        type: "GET",
        headers: {
            "ModuleId": ModuleId,
            "TabId": TabId,
    ...
    $scope.AddCard = function () {
        ...
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/AddCard",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
...
routerApp.controller('ctrRoomsPackageDetails', function ($scope, $http, $stateParams) {
    $scope.RemoveRoominRoomsPackage = function (id) {
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/RemoveRoominRoomsPackage",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
            ...
            success: function (data2) {
                $.ajax({
                    url: siteRoot + "DesktopModules/MVC/NeyrizanAds/Package/GetRoomsintoRoomsPackage?PackageID=" + $stateParams.id,
                    method: "Get",
                    headers: {
                        "ModuleId": ModuleId,
                        "TabId": TabId,
    ...
    $scope.AddRoominRoomPackage = function () {
        ...
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/AddRoomsintoRoomsPackage",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
    ...
    $.ajax({
        url: "/DesktopModules/MVC/NeyrizanAds/GDS/getCity",
        type: "GET",
        headers: {
            "ModuleId": ModuleId,
            "TabId": TabId,
    ...
    $scope.CityChanged = function () {
        ...
        $.ajax({
            url: siteRoot + "DesktopModules/MVC/NeyrizanAds/GDS/gethotel?cityid=" + $scope.mdlCity.value,
            method: "Get",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
    ...
    $scope.HotelChanged = function () {
        ...
        $.ajax({
            url: siteRoot + "DesktopModules/MVC/NeyrizanAds/GDS/GetRoomsInhote?HotelID=" + $scope.mdlHotel.value + "&CityID=" + $scope.mdlCity.value,
            method: "Get",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
...
routerApp.controller('ctrPackageDetails', function ($scope, $http, $stateParams) {
    $scope.AddRoomPackageintoPackage = function () {
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/AddRoomPackageIntoPackages",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
            ...
            success: function (data2) {
                $.ajax({
                    url: siteRoot + "DesktopModules/MVC/NeyrizanAds/Package/GetRoomPackageinPackage?PackageID=" + $stateParams.id,
                    method: "Get",
                    headers: {
                        "ModuleId": ModuleId,
                        "TabId": TabId,
    ...
    $.ajax({
        url: "/DesktopModules/MVC/NeyrizanAds/Package/GetPackageDetails",
        type: "GET",
        headers: {
            "ModuleId": ModuleId,
            "TabId": TabId,
    ...
    $.ajax({
        url: "/DesktopModules/MVC/NeyrizanAds/Package/GetAllRoomsPackages",
        type: "GET",
        headers: {
            "ModuleId": ModuleId,
            "TabId": TabId,
...
routerApp.controller('ctrPackageLists', function ($scope, $http) {
    $scope.RemovePackage = function (id) {
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/RemovePackage",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
    ...
    $scope.AddPackage = function () {
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/AddPackage",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
...
routerApp.controller('ctrRoomsLists', function ($scope, $http) {
    $scope.RemoveRoomsPackage = function (id) {
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/RemoveRoomsPackage",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
    ...
    $scope.AddRoomsPackage = function () {
        $.ajax({
            url: "/DesktopModules/MVC/NeyrizanAds/Package/AddRoomsPackage",
            type: "GET",
            headers: {
                "ModuleId": ModuleId,
                "TabId": TabId,
