...
!function(e){"use strict";"function"==typeof define&&define.amd?define(["dnnsfjQuery","dnnsf","./jquery.fileupload-process"],e):"object"==typeof exports?e(require("dnnsfjQuery","dnnsf")):e(window.dnnsfjQuery,window.dnnsf)}(function(e,i){"use strict";i.useLocalization=function(){e.blueimp.fileupload.prototype.options.processQueue.push({action:"validate",always:!0,acceptFileTypes:"@",maxFileSize:"@",minFileSize:"@",maxNumberOfFiles:"@",disabled:"@disableValidation"}),e.widget("blueimp.fileupload",e.blueimp.fileupload,{options:{getNumberOfFiles:e.noop,messages:{maxNumberOfFiles:i.localization.fileupload.maxNumberOfFiles,acceptFileTypes:i.localization.fileupload.acceptFileTypes,maxFileSize:i.localization.fileupload.maxFileSize,minFileSize:i.localization.fileupload.minFileSize}},processActions:{validate:function(i,l){if(l.disabled)return i;var r,s=e.Deferred(),n=this.options,o=i.files[i.index];return(l.minFileSize||l.maxFileSize)&&(r=o.size),"number"===e.type(l.maxNumberOfFiles)&&(n.getNumberOfFiles()||0)+i.files.length>l.maxNumberOfFiles?o.error=n.i18n("maxNumberOfFiles"):!l.acceptFileTypes||l.acceptFileTypes.test(o.type)||l.acceptFileTypes.test(o.name)?r>l.maxFileSize?o.error=n.i18n("maxFileSize"):"number"===e.type(r)&&r<l.minFileSize?o.error=n.i18n("minFileSize"):delete o.error:o.error=n.i18n("acceptFileTypes"),o.error||i.files.error?(i.files.error=!0,s.rejectWith(this,[i])):s.resolveWith(this,[i]),s.promise()}}})}});
